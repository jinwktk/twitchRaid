...
- `npm run perf:sub-ai-services` は実チャット送信・mem0書込みなしで、Scheduled Taskと配置script hash、実効BotのAI/mem0/SearXNG設定、6サービス1/1、計測中task不変・restart/error 0、固定生成、768次元embed、score閾値付きmem0、SearXNG結果、各p95上限を検証する。実行にはSSH alias `sub` と稼働中のSUB AI Servicesが必要
