...
## 更新履歴
- **2026-07-05**: `CHAT_AI_PROMPT_REPLY_LOG_ENABLED=true` の成功時全文診断ログをINFOではなくSUCCESSログへ変更し、ヘッダも `AIメンション会話プロンプト/返信:` から `AIメンション会話プロンプト/Success:` へ変更した。ログ本文の `プロンプト：...` / `返信：...` と、失敗時の `AIメンション会話プロンプト/失敗:` は従来どおり。
